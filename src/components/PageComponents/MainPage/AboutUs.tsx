            ...
            <div className='relative flex items-center justify-between overflow-hidden rounded-lg bg-[#111111] py-[25px] lg:py-[40px] lg:pr-[30px]'>
              ...
              <div className='z-10 flex w-1/2 flex-col items-center'>
                <Link
                  ...
                  rel='noopener noreferrer'
                >
                  <div className='group relative flex h-[70px] w-[70px] items-center justify-center rounded-full border border-[#FE9900] bg-[#111111] from-[#FE9900] via-[#FD6B06] to-[#985C00] p-[1px] transition delay-200 hover:bg-gradient-to-r lg:h-[100px] lg:w-[100px]'>
                    <svg
                      width='25'
                      height='18'
                      viewBox='0 0 25 18'
                      ...
                      className='group-transition hidden text-white transition-colors delay-200 hover:text-black lg:block'
                    >
                    ...
                    <svg
                      ...
                      viewBox='0 0 23 17'
                      xmlns='http://www.w3.org/2000/svg'
                      className='group-transition text-white transition-colors delay-200 hover:text-black lg:hidden'
                      fill='currentColor'
                    >
              ...
              >
                <div className='group relative flex h-[70px] w-[70px] items-center justify-center rounded-full border border-[#FE9900] bg-[#111111] from-[#FE9900] via-[#FD6B06] to-[#985C00] p-[1px] transition delay-200 hover:bg-gradient-to-r lg:h-[100px] lg:w-[100px]'>
                  <svg
                    ...
                    viewBox='0 0 23 23'
                    xmlns='http://www.w3.org/2000/svg'
                    className='delay-200group-transition text-white transition delay-200 hover:text-black group-focus:text-black lg:hidden'
                    fill='currentColor'
                  >
