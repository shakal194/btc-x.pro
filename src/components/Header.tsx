        ...
        <div className='flex items-center justify-between rounded-lg border border-gray-400 px-5 py-[7px] backdrop-blur-md lg:py-[10px]'>
          ...
          <div className='hidden items-center space-x-4 lg:flex'>
            ...
            <Link
              ...
              target='_blank'
              rel='noopener noreferrer'
              className='rounded-full border px-5 py-3 text-primary font-bold leading-[110%] transition delay-200 hover:border-[#FD6B06] hover:bg-[#FD6B06] hover:text-white focus:bg-[#FD6B06] focus:text-white'
            >
              {t('app')}
            </Link>
          </div>
