        ...
        <div className='flex gap-2'>
          <div className='z-20'>
            ...
            <div className='mt-[20px] lg:mt-[186px] lg:w-[435px] lg:rounded-lg lg:bg-gradient-to-r lg:from-[#553300] lg:to-[#FE9900] lg:p-[1px]'>
              <div className='lg:rounded-lg lg:bg-black lg:px-[25px] lg:py-6'>
                ...
                <div className='lg:my-6 lg:border-t lg:opacity-[33%]'></div>
          ...
          <div className='pointer-events-none absolute -right-[225px] top-[-190px] z-10 hidden w-[110%] lg:block'>
            <Image
