        ...
        <div className='flex gap-4'>
          <div className='relative rounded-lg bg-gradient-to-r from-[#FFFFFF]/15 to-[#FFFFFF]/30 p-[1px]'>
            <div className='flex rounded-lg bg-[#111111] py-[40px] pr-[30px]'>
              <div className='flex flex-col items-center'>
                <div className='group relative mb-[50px] flex h-[100px] w-[100px] items-center justify-center rounded-full border border-[#FE9900] bg-[#111111] from-[#FE9900] via-[#FD6B06] to-[#985C00] p-[1px] hover:bg-gradient-to-r'>
                  <Link
                ...
                <h4 className='mb-5 text-center text-[22px] leading-[120%]'>
                  Ми в Youtube
                </h4>
          ...
          <div className='relative rounded-lg bg-gradient-to-r from-[#FFFFFF]/15 to-[#FFFFFF]/30 p-[1px]'>
            <div className='flex h-full w-[210px] flex-col items-center rounded-md bg-[#111111] py-[40px]'>
              ...
              <h4 className='mb-5 text-[22px] leading-[120%]'>Ми в Telegram</h4>
              <p className='text-center text-[14px] opacity-[33%]'>
          ...
          <div className='relative rounded-lg bg-gradient-to-r from-[#FFFFFF]/15 to-[#FFFFFF]/30 p-[1px]'>
            <div className='flex h-full w-[210px] flex-col items-center rounded-md bg-[#111111] py-[40px]'>
              ...
              <h4 className='mb-5 text-[22px] leading-[120%]'>Ми у Twitter</h4>
              <p className='text-center text-[14px] opacity-[33%]'>
          ...
          <div className='relative rounded-lg bg-gradient-to-r from-[#FFFFFF]/15 to-[#FFFFFF]/30 p-[1px]'>
            <div className='flex h-full w-[210px] flex-col items-center rounded-md bg-[#111111] py-[40px]'>
              ...
              <h4 className='mb-5 text-[22px] leading-[120%]'>
                Ми в Instagram
              </h4>
              <p className='text-center text-[14px] opacity-[33%]'>
